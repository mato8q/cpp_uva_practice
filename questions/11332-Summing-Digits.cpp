...
10. It is easy to see that the sequence of num-
bers n, f (n), f (f (n)), f (f (f (n))), . . . eventually
...
Input
Each line of input contains a single positive inte-
ger n at most 2,000,000,000. Input is terminated
